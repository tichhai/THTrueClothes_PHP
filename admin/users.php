<?php
   ...
   if (isset($_GET['name'])) {
     $name = trim($_GET['name']); 
     try {
       $countSql = "SELECT COUNT(*) FROM user WHERE name LIKE :name";
                      ...
                      <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                          ...
                          <tr>
                              ...
                              <td class="pname">
                                <div class="image">
                                  <img src="<?php echo $user["image"]?>" alt="" class="image" />
                                </div>
                                <div class="name">
                                  <a href="#" class="body-title-2"><?php echo $user["name"]?></a>
                                </div>
                              </td>
                              <td><?php echo $user["phone"]?></td>
                              <td style="overflow:hidden"><?php echo $user["email"]?></td>
                              <td><?php echo $user["role"]?></td>
                              <td>
                                <?php echo $user["status"]?>
                                <a style="margin-left: 25px;" href="changes-user.php?id=<?php echo $user["id"]?>&status=<?php echo $user["status"]?>">Change status</a>
                              </td>
                              <td class="text-center">
                                <a href="orders.php" target="_blank">
                                  <?php
                                    try{
                                      $sql = "SELECT * FROM `order` WHERE user=:user_id";
                                      $stmt = $pdo->prepare($sql);
