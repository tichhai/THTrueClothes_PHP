              ...
              <div class="main-content-inner">
                ...
                <div class="main-content-wrap">
                  ...
                  <form
                    ...
                    action="editing-product.php?id=<?php echo $product["id"]?>"
                  >
                    <input
                      type="hidden"
                      name="_token"
                    ...
                    <div class="wg-box">
                      ...
                      <fieldset>
                        ...
                        <div class="upload-image mb-16" id="galleryPreview">
                            <?php 
                             try {
                                $sql = "SELECT * FROM product_images WHERE product=:product_id";
                                $stmt = $pdo->prepare($sql);
                        ...
                        <fieldset class="name">
                          ...
                          <div class="select mb-10">
                            <select class="" name="stock_status">
                              <option value="0" <?php echo $product["stock"] == 0 ? "selected" : ""; ?>>Out of Stock</option>
                              <option value="1" <?php echo $product["stock"] == 1 ? "selected" : ""; ?>>InStock</option>
                            </select>
                          </div>
                        </fieldset>
                        <fieldset class="name">
